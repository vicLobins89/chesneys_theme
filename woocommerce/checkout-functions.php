...
function send_csv_mail($csv_data, $body, $to = 'vic.lobins@gmail.co.uk, vitalijs_l@hotmail.co.uk, vic@honey.co.uk, SwiftcareAdmin@Swiftcareuk.com, adam@chesneys.co.uk, lucy.powell@swiftcareuk.com, rachel@swiftcareuk.com',  $from = 'admin@chesneys.co.uk', $subject = 'Product Order from Chesneys.co.uk') {
