...
function send_csv_mail($csv_data, $body, $order_number = '', $customer = '', $to = 'vic@honey.co.uk',  $from = 'Chesneys Order <no-reply@chesneys.co.uk>', $subject = 'Product Order from Chesneys.co.uk') {
