...
if ( woocommerce_product_loop() ) {
	...
	<?php
	if( $blog_id == 5 && (term_is_ancestor_of(16, $term->term_id, 'product_cat') || is_product_category(16) || term_is_ancestor_of(68, $term->term_id, 'product_cat') || is_product_category(68)) ) {
		get_sidebar('filter');
