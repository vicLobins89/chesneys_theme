	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div id="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				echo '<a href="'.wc_get_cart_url().'" class="menu-item" title="View your shopping cart"><span>'.sprintf ( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ).'</span>Basket</a>';
				echo '</div>';
				?>
				</nav>
